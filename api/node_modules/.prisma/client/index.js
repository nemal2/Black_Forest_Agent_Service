...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\4_semester\\web application\\Final_Project\\Black_Forest\\api\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"mongodb\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Post {\n  id         String      @id @default(auto()) @map(\"_id\") @db.ObjectId\n  title      String\n  price      String //date\n  images     String[]\n  address    String\n  city       String\n  bedroom    Int //deaths\n  bathroom   Int //injured\n  latitude   String\n  longitude  String\n  type       Type\n  property   Property\n  createdAt  DateTime    @default(now())\n  user       User        @relation(fields: [userId], references: [id])\n  userId     String      @db.ObjectId\n  postDetail PostDetail?\n  savedPosts SavedPost[] //each post can have multiple savedposts\n}\n\nenum Type {\n  Red_Alert\n  Orange_Alert\n  Blue_Alert\n}\n\nenum Property {\n  Global_Terrorism\n  Regional\n  Political\n  Black_Market\n}\n\nmodel PostDetail {\n  id         String  @id @default(auto()) @map(\"_id\") @db.ObjectId\n  desc       String\n  utilities  String?\n  pet        String?\n  income     String?\n  size       Int?\n  school     Int?\n  bus        Int?\n  restaurant Int?\n  post       Post    @relation(fields: [postId], references: [id])\n  postId     String  @unique @db.ObjectId\n}\n\nmodel SavedPost {\n  id        String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  user      User     @relation(fields: [userId], references: [id])\n  post      Post     @relation(fields: [postId], references: [id])\n  userId    String   @unique @db.ObjectId\n  postId    String   @unique @db.ObjectId\n  createdAt DateTime @default(now())\n\n  @@unique([userId, postId])\n}\n\nmodel User {\n  id         String      @id @default(auto()) @map(\"_id\") @db.ObjectId\n  email      String      @unique\n  username   String      @unique\n  password   String\n  avatar     String?\n  createdAt  DateTime    @default(now())\n  posts      Post[] //single user can create multiple posts\n  savedPosts SavedPost[] //each user can have multiple savedposts\n  chats      Chat[]      @relation(fields: [chatIDs], references: [id])\n  chatIDs    String[]    @db.ObjectId\n}\n\nmodel Chat {\n  id          String    @id @default(auto()) @map(\"_id\") @db.ObjectId\n  users       User[]    @relation(fields: [userIDs], references: [id])\n  userIDs     String[]  @db.ObjectId\n  createdAt   DateTime  @default(now())\n  seenBy      String[]  @db.ObjectId\n  messages    Message[]\n  lastMessage String?\n}\n\nmodel Message {\n  id        String   @id @default(auto()) @map(\"_id\") @db.ObjectId\n  text      String\n  userId    String\n  chat      Chat     @relation(fields: [chatId], references: [id])\n  chatId    String   @db.ObjectId\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "1456bc1eecf10b0289caf4e077370992b6509b608a155a5e4eeb281b244f67d8",
  "copyEngine": true
}
